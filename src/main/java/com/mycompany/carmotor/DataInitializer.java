...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        if (vehicleRepository.count() > 0) {
            assignBranchesToVehiclesWithoutBranch(branches);
            return;
        }
        ...
        Advisor a2 = new Advisor("Laura Gomez", "/img/advisor2.jpg", "cel: 310-444-5566");
        advisorRepository.saveAll(List.of(a1, a2));

        Vehicle v1 = new Vehicle("Toyota", 2020, 45000000, "Sedan", 5, 3, List.of());
        v1.setAdvisor(a1);
        v1.setBranch(b1);
        ...
        v2.addMaintenance(new MaintenanceRecord(LocalDate.of(2023, 8, 5), true, true, "AutoServicios Bogota"));
        ...
        if (bankEntityRepository.count() == 0) {
            bankEntityRepository.saveAll(List.of(
                    ...
                    new BankEntity("Banco Bogota", "/img/bancobogota.png", "601-332-0000")
            ));
        }
    }

    private List<Branch> seedDefaultBranches() {
        Branch b1 = new Branch("CarMotor Bogota Norte", "Av. 19 # 122-45, Bogota", "601-745-1234",
                "Mon-Fri 8am-6pm, Sat 9am-2pm");
        b1.setTestDriveSlots(new ArrayList<>(List.of(
                "Mon Jun 02 - 9:00am",
                "Mon Jun 02 - 11:00am",
                "Tue Jun 03 - 10:00am",
                "Wed Jun 04 - 2:00pm",
        ...
        Branch b2 = new Branch("CarMotor Medellin", "Calle 10 # 43E-31, Medellin", "604-444-5678",
                "Mon-Fri 8am-6pm, Sat 9am-1pm");
        b2.setTestDriveSlots(new ArrayList<>(List.of(
                "Tue Jun 03 - 9:00am",
                "Thu Jun 05 - 11:00am",
                "Sat Jun 07 - 10:00am")));

        Branch b3 = new Branch("CarMotor Cali", "Carrera 5 # 15-20, Cali", "602-330-9876",
                "Mon-Sat 9am-5pm");
        b3.setTestDriveSlots(new ArrayList<>(List.of(
                "Mon Jun 02 - 10:00am",
                "Wed Jun 04 - 9:00am",
                "Fri Jun 06 - 3:00pm")));

        return branchRepository.saveAll(List.of(b1, b2, b3));
    }

    private void assignBranchesToVehiclesWithoutBranch(List<Branch> branches) {
        if (branches.isEmpty()) {
            return;
        }
        ...
        for (int i = 0; i < vehicles.size(); i++) {
            ...
            if (vehicle.getBranch() == null) {
                vehicle.setBranch(branches.get(i % branches.size()));
    ...
    private Photo createPhoto(String area, String path, Vehicle vehicle) {
        Photo photo = new Photo(area, path);
